...
When reviewing a pull request for this project, verify each of the following items derived from the project constitution. The PR **MUST NOT** be merged until every applicable item is confirmed.
